...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_StateWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_StateWidget_t qt_meta_stringdata_StateWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_StateWidget[] = {
...
Q_CONSTINIT const QMetaObject StateWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_StateWidget.offsetsAndSizes,
    qt_meta_data_StateWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_StateWidget_t,
        // Q_OBJECT / Q_GADGET
